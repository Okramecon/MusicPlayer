...
namespace MusicPlayer.DAL.Migrations
{
    ...
    [Migration("20220107142149_PlalistTrackTableAdded")]
    partial class PlalistTrackTableAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicPlayer.DAL.Entities.PlaylistTrack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MusicPlayer.DAL.Entities.PlaylistTrack", b =>
                {
                    b.HasOne("MusicPlayer.DAL.Entities.Playlist", "Playlist")
                        .WithMany("Tracks")
                        .HasForeignKey("PlaylistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicPlayer.DAL.Entities.Track", "Track")
                        .WithMany("Playlists")
